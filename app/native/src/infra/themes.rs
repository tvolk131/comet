...
static BUNDLED_THEMES_DIR: Dir<'_> = include_dir!("$CARGO_MANIFEST_DIR/assets/themes");
...
fn themes_dir(app: &AppContext) -> Result<PathBuf, AppError> {
...
pub fn list_themes(app: &AppContext) -> Result<Vec<ThemeSummary>, AppError> {
...
pub fn read_theme(app: &AppContext, theme_id: &str) -> Result<ThemeData, AppError> {
