...
pub fn apply_remote_snapshot_event(
    ...
    if collection.as_deref()
        == Some(crate::adapters::nostr::comet_tag_metadata_snapshot::COMET_TAG_METADATA_COLLECTION)
    {
        let applied = crate::domain::sync::tag_metadata_apply::apply_remote_tag_metadata_snapshot(
